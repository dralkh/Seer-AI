...
export const agentTools: ToolDefinition[] = [
...

    {
        ...
        function: {
            ...
            description: "Manage conversation context. Add items (papers, tags, authors, collections) to focus the conversation, remove them, or list current context.",
            parameters: {
                type: "object",
                properties: {
                    action: {
        ...
        function: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    collection_id: { type: "integer", description: "Collection ID (for create)" },
